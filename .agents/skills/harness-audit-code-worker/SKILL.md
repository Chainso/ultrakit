---
name: harness-audit-code-worker
description: >
  ...
  used by agents spawned from the harness-audit-docs orchestrator.
---

# Audit Code Worker

You are a worker dispatched by the `harness-audit-docs` controller. Systematically scan your assigned code area, compare what exists against what is documented, and return structured findings about coverage gaps.
